<template>
	<div>
		<div class="clearfix">
			<Modal v-model="visible" title="小组成员2323423" class="modal-ct" width="550" :styles="{top: '250px'}" @on-cancel="cancelBtn">
				<div slot="footer">
				...
				<div class="groupMembers" v-if="!selectShow">
					...
					<div>
						<h2>副组长</h2>
						<ul class="membersImg">
							<li v-for="item in secondLeader">
								<img src="../../../../../../images/ksh/tou.png" alt="" onerror="this.src=../../../../../../images/ksh/tou.png" />
								<p>{{item.xm}}</p>
							</li>
						</ul>
						<h2>成员</h2>
