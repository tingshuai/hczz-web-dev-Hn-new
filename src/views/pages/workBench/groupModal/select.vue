<template>
	<el-dialog class="modal-ct workBench-group-modal" title="选择" @close='closeModel' :visible.sync="visible" :modal-append-to-body='false' width="600px">
		<div slot="footer">
		...
		<li>
			...
			<el-scrollbar tag="ul" wrap-class="el-scrollbar-wrap" view-class="el-scrollbar-view" ref="scrollbar" class="dept-search-ct">
				...
				<el-radio v-model="radio1" label="2">所有1</el-radio>
