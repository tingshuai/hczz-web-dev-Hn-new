<template>
  <div class="taskIndex">
    <task :taskList="setTaskList" @over="over" @additionalBtn="additionalBtn" :zt="zt" ref="task"></task>
      ...
      methods: {
          ...
          deterBtn () { // 签收确定按钮
              api.api('post', api.configUrl + '/hczz/za/rwQs', {
                  ...
                  this.$emit('signSuccess', '1');
              });
          },
          overDeterBtn () { // 结束研判确定按钮
              let thczzrwfp = {
                  id: this.taskItem.id,
                  rwzt: '4'
              };
          ...
          updateFeedback (val) { // 反馈成功后回调  val有值代表反馈成功  刷新  没有值代表取消 不刷新
